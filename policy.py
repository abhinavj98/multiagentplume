...
from distribution import MultiAgentMultiCategoricalDistribution
...
from modules import MultiAgentMLPExtractor
from modules import MultiAgentNet, MultiAgentValueNet
...
class MultiAgentPolicy(MultiInputActorCriticPolicy):
    ...
    def _build_mlp_extractor(self) -> None:
        ...
        #       net_arch here is an empty list and mlp_extractor does not
        #       really contain any layers (acts like an identity module).
        self.mlp_extractor = MultiAgentMLPExtractor(
            self.features_dim,
    ...
    def make_proba_distribution(
        ...
        if isinstance(action_space, spaces.Box):
            ...
            return MultiAgentMultiCategoricalDistribution(list(action_space.nvec), **dist_kwargs)
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        self.value_net = MultiAgentValueNet(self.mlp_extractor.latent_dim_vf, 1,  self.num_agents)
        # Init weights: use orthogonal initialization
        # with small initial weight for the output
        if self.ortho_init:
            # TODO: check for features_extractor
